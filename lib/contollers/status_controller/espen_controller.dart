...
class ESPENController extends GetxController{
  ...
  Future<String> saveData(
    ...
    try {
      ...
      Request request = Request(url: APIUrls.PostStatus, body: {
        ...
        "status": nutritionalDiagnosis.espen,
        'score': '0',
  ...
  Future<String> saveDataOffline(
    ...
    try {
      ...
      await  returnPatientDAtaFromNRS(data,0,dataa,nutritionalDiagnosis.espen,statusType.nutritionalDiagnosis).then((value){
