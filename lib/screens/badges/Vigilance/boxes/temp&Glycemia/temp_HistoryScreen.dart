...
class Temp_HistoryScreen extends StatefulWidget {
  final String HistoryName;
  final PatientDetailsData patientDetailsData;

  const Temp_HistoryScreen({Key key, this.HistoryName, this.patientDetailsData})
      : super(key: key);
...
class _BloodPressure_HistoryScreenState extends State<Temp_HistoryScreen> {
  ...
  void initState() {
    ...
    checkConnectivity().then((internet) {
      ...
      if (internet != null && internet) {
        temp_glycemiaController.get_Temp_HistoryData(
        ...
        body: Obx(
          () => Padding(
            ...
            child: Container(
              child: ListView(
                children:
                    temp_glycemiaController.temp_historyData.map((element) {
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '('+  '${e2.data.map((e) => e.flag)}'.toLowerCase().replaceAll('(', '').replaceAll(')', '').toString().tr + ')',
                                      style: TextStyle(fontSize: 15),
                                    ),
                                  ],
                                )
