...
class NonNutritionalCalories extends StatefulWidget {
  ...
  NonNutritionalCalories({this.propofol,this.citrate,this.total,this.glucos,this.onUpdate});
  @override
  _NonNutritionalCaloriesState createState() => _NonNutritionalCaloriesState();
}

class _NonNutritionalCaloriesState extends State<NonNutritionalCalories> {
