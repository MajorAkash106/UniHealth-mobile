...
class Update_PatientInfo extends StatefulWidget {
  final String title;
  final RxList<PatientDetailsData> patientDetail;
  final selectedHospital;

  Update_PatientInfo({this.title, this.patientDetail, this.selectedHospital});

  @override
  _Update_PatientInfoState createState() => _Update_PatientInfoState();
}

class _Update_PatientInfoState extends State<Update_PatientInfo> {
  ...
  void initState() {
    ...
    checkConnectivity().then((internet) {
      ...
      if (internet != null && internet) {
        selectedHospital =
            selectedHospital ?? widget.patientDetail[0].hospital[0].sId;
        _controller.getHospitalData().then((value) {
          var selectedData = _controller.hospListdata.firstWhere((element) =>
              element.sId == widget.patientDetail[0].hospital[0].sId);
    ...
    hospitalname =
        TextEditingController(text: widget.patientDetail[0].hospital[0].name);
    ...
    insuranceCompany =
        TextEditingController(text: widget.patientDetail[0].insurance);
  ...
  void get_ward_data() {
    _controller.getWardData(selectedHospital).then((value) {
      _controller.getEditBedData(selectedWard, widget.patientDetail[0].bedId.sId)
          .then((value) {
        setState(() {
                      ...
                      child: Container(
                        child: Column(
                          children: [
                            ...
                            _textfield(
                                "name".tr, patientName, TextInputType.text,
                                readonly: false),
                            SizedBox(
                              height: 20,
                            ),
                            ...
                            _textfield(
                                "email".tr, email, TextInputType.emailAddress,
                                readonly: false),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Flexible(
                                    flex: 1,
                                    child: _textfield(
                                        "r_id".tr, rId, TextInputType.text,
                                        readonly: false)
                            ...
                            _textfield("insurance".tr, insuranceCompany,
                                TextInputType.text,
                                readonly: false),
  ...
  Widget hospitalListWidget() {
    return DropdownButtonFormField(
        ...
        //==null?widget.patientDetail[0].hospital[0].sId:selectedHospital,
        iconEnabledColor: primary_color,
        icon: Icon(null),
        // items: [DropdownMenuItem(child: Text('abc'),value: selectedHospital,)],
        items: widget.patientDetail[0].hospital
            .map((e) =>
  ...
  Widget wardListWidget() {
    return DropdownButtonFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(
              color: widget.title == "Update_patient_info".tr
                  ? Colors.black
                  : null),
          // suffixIcon: Icon(Icons.arrow_drop_down)
        ),
        ...
        value: selectedWard,
        //==null?widget.patientDetail[0].wardId.sId:selectedWard,
        iconEnabledColor: primary_color,
        icon: Icon(null),
  ...
  Widget bedListWidget() {
    ...
    return InkWell(
      ...
      child: DropdownButtonFormField(
          ...
          // ) ,
          value: selectedBed,
          //??widget.patientDetail[0].sId,//:selectedBed,
          iconEnabledColor: primary_color,
          // disabledHint: Text(widget.patientDetail[0].bedId.bedNumber),
          icon: Icon(null),
          items: _controller.bedListdata
  ...
  Widget medicalListWidget() {
    return DropdownButtonFormField(
        ...
        items:
            ...
            _controller.medicalListdata == null
                ? []
                : _controller.medicalListdata
                    .map((e) => DropdownMenuItem<String>(
  ...
  Widget date_of_admit(text, value) {
    return DateTimeField(
      ...
      // enabled: false,
      initialValue:
          widget.title == "Update_patient_info".tr ? admit_date : Null,
